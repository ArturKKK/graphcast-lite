...
Usage:
    python -m src.unet.predict_v2 experiments/unet_v2_region_krsk
    python -m src.unet.predict_v2 experiments/unet_v2_region_krsk --ar-steps 4 --max-samples 200
"""
import argparse
import json
import os
...
def main():
    ...
    model = WeatherUNetV2(
        in_channels=obs_window * C, out_channels=C,
    ...
    model.eval()
    print(f"[predict_v2] Loaded {ckpt_path} ({model.num_params:,} params)")
