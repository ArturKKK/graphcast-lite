...
def station_terrain(dem: np.ndarray, center: tuple[int, int], lat_deg: float,
    ...
    ``cell_deg`` — шаг матрицы высот в градусах (у Copernicus GLO-90 это 3
    угловые секунды, 1/1200). Шаг по долготе в метрах короче, чем по широте, и
    учитывается: на 55° градус долготы вдвое короче градуса широты.
    """
