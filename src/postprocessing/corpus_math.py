...
def wind_components(speed, direction):
    ...
    Штиль. При нулевой скорости направления не существует, и оно может быть
    помечено пропуском; прямая формула дала бы тогда NaN, хотя вектор очевидно
    нулевой. На красноярском корпусе это ни разу не сработало — там у всех
    19 801 штиля направление проставлено, — но на другом наборе наблюдений
    штиль кодируют иначе, и терять его нельзя: относительная ошибка модели у
    штиля наибольшая. При нулевой скорости вектор нулевой, каким бы ни было
    направление.
    """
