...
def get_bipartite_graph_spatial_features(
    *,
    ...
    add_node_positions: bool = True,
    add_node_latitude: bool = True,
    add_node_longitude: bool = True,
    add_relative_positions: bool = False,
    edge_normalization_factor: Optional[float] = None,
    relative_longitude_local_coordinates: bool = False,
    relative_latitude_local_coordinates: bool = False,
...
def get_mesh_lat_long(finest_mesh: TriangularMesh):
    ...
    (
        mesh_nodes_lat,
        mesh_nodes_lon,
    ) = spherical_to_lat_lon(phi=mesh_phi, theta=mesh_theta)

    return mesh_nodes_lat.astype(np.float32), mesh_nodes_lon.astype(np.float32)
